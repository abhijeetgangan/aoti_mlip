...
- **Tuple-based interface** for efficient AOT compilation

Note:
    The forward method accepts individual tensor arguments (not dictionaries).
"""
...
class M3Gnet(nn.Module):
    ...
    def forward(
        ...
        pos = atom_pos
        pbc_offsets = pbc_offsets.float()
        edge_index = edge_index.long()
        three_body_indices = three_body_indices.long()
