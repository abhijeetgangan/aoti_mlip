...
def unpack_graph_batch(graph_batch: Data) -> tuple:
    """Convert PyG graph batch to tuple of tensors for AOT-compiled model.

    Args:
        graph_batch: PyTorch Geometric batch object from dataloader

    Returns:
        Tuple of 12 tensors matching the AOT-compiled model signature
    """
    return (
        graph_batch.atom_pos,
        graph_batch.cell,
        graph_batch.pbc_offsets,
        graph_batch.atom_attr,
        graph_batch.edge_index,
        graph_batch.three_body_indices,
        graph_batch.num_three_body,
        graph_batch.num_bonds,
        graph_batch.num_triple_ij,
        graph_batch.num_atoms,
        torch.tensor(graph_batch.num_graphs),
        graph_batch.batch,
    )
