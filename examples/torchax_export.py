...
from aoti_mlip.models.mattersim import M3GnetEnergyModel, M3GnetModel, M3GnetWrapper
...
# print(grads)
batch_const = tuple(jax.lax.stop_gradient(x) for x in batch_tuples[2:])  # exclude cell (idx 1)
